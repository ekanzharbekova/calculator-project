...
function App() {
  ...
  return (
    <div className="app">
      <div className="links">
        <a href="https://github.com/ekanzharbekova/calculator-project" target="_blank" rel="noreferrer"> <p>GitHub</p> <img alt="blue mountains"  src="https://img.icons8.com/glyph-neue/64/000000/github.png"/></a>
      </div>
